...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, EventDto> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.aston.homework.dto");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.aston.homework.dto.EventDto");
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventDto> kafkaListenerContainerFactory(ConsumerFactory<String, EventDto> consumerFactory) {
